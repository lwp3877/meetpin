...
const DEFAULT_STEPS: OnboardingStep[] = [
  ...
  },
  {
    ...
    title: '첫 모임 만들기',
    description:
      '원하는 장소에 핀을 찍고 새로운 모임을 만들어보세요. 술친구, 운동 파트너, 취미 모임까지!',
    icon: '🎯',
    action: {
      label: '모임 만들기',
      onClick: () => {},
...
export default function Onboarding({
  ...
  return (
    <ModalAnimation show={isVisible} onClose={handleSkip}>
      <div className="relative m-4 mx-auto max-w-md rounded-2xl bg-white p-8 shadow-2xl">
        {/* Progress indicator */}
        ...
        <div className="text-center">
          {/* Icon */}
          <div className="mb-4 animate-bounce text-6xl">{current.icon}</div>

          {/* Title */}
          <h2 className="mb-4 text-xl font-bold text-gray-900">{current.title}</h2>

          {/* Description */}
          <p className="mb-8 leading-relaxed text-gray-600">{current.description}</p>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-between">
              ...
              <EnhancedButton onClick={handleNext} variant="ghost" size="sm" disabled={isLastStep}>
                다음
              </EnhancedButton>
            </div>
          </div>

    ...
    loading: () => (
      <div className="flex h-32 items-center justify-center rounded-lg border-2 border-dashed border-gray-300">
        <div className="text-center">
          <LoadingSpinner />
          <p className="mt-2 text-sm text-gray-500">업로더 준비 중...</p>
        </div>
      </div>
    ),
    ssr: false,
...
const ProfileImageUploader = dynamic(
  () =>
    import('@/components/ui/ProfileImageUploader').then(mod => ({
      default: mod.ProfileImageUploader,
    })),
  {
    loading: () => (
...
export {
  ImageUploader as LazyImageUploader,
  ProfileImageUploader as LazyProfileImageUploader,
  RoomImageUploader as LazyRoomImageUploader,
}

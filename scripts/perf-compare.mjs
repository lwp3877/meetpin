...
function printReport(report) {
  ...
  console.log('\n📊 상세 비교:')
  console.log('번들 크기:')
  console.log(`   초기 JS: ${report.details.bundle.baseline.initialJS}KB → ${report.details.bundle.current.initialJS}KB (${report.details.bundle.percentChange.initialJS}%)`)
  console.log(`   전체 JS: ${report.details.bundle.baseline.totalJS}KB → ${report.details.bundle.current.totalJS}KB (${report.details.bundle.percentChange.totalJS}%)`)
  console.log(`   CSS: ${report.details.bundle.baseline.totalCSS}KB → ${report.details.bundle.current.totalCSS}KB (${report.details.bundle.percentChange.totalCSS}%)`)
  
  console.log('Web Vitals:')
  console.log(`   LCP: ${report.details.webVitals.baseline.LCP}ms → ${report.details.webVitals.current.LCP}ms (${report.details.webVitals.percentChange.LCP}%)`)
  console.log(`   TBT: ${report.details.webVitals.baseline.TBT}ms → ${report.details.webVitals.current.TBT}ms (${report.details.webVitals.percentChange.TBT}%)`)
  console.log(`   CLS: ${report.details.webVitals.baseline.CLS} → ${report.details.webVitals.current.CLS} (${report.details.webVitals.percentChange.CLS}%)`)
  
  console.log('Lighthouse:')
  console.log(`   Performance: ${report.details.lighthouse.baseline.performance} → ${report.details.lighthouse.current.performance} (${report.details.lighthouse.diff.performance > 0 ? '+' : ''}${report.details.lighthouse.diff.performance})`)
  console.log(`   Accessibility: ${report.details.lighthouse.baseline.accessibility} → ${report.details.lighthouse.current.accessibility} (${report.details.lighthouse.diff.accessibility > 0 ? '+' : ''}${report.details.lighthouse.diff.accessibility})`)
}

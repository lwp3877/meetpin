        ...
        <section className={`py-20 px-4 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              근처에서 함께 운동할 메이트를 찾아보세요!<br />
              러닝, 헬스, 테니스부터 요가까지 다양한 운동 친구들과 만나요
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="text-lg px-8 bg-emerald-600 hover:bg-emerald-700" onClick={() => router.push('/map?category=exercise')}>
                <MapPin className="mr-2 h-5 w-5" />
                근처 운동모임 찾기
              </Button>
              <Button size="lg" variant="outline" className="text-lg px-8" onClick={() => router.push('/room/new?category=exercise')}>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {BENEFITS.map((benefit, index) => (
                <Card key={benefit.title} className={`hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 ${isVisible ? 'animate-in slide-in-from-bottom-4' : ''}`} 
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {EXERCISE_TYPES.map((exercise, index) => (
                <Card key={exercise.type} className={`hover:shadow-md transition-all duration-300 cursor-pointer ${isVisible ? 'animate-in slide-in-from-right-4' : ''}`}
                      style={{ animationDelay: `${index * 0.1}s` }}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3">실력별 매칭</h3>
                <p className="text-gray-600">초보자부터 고수까지, 내 실력에 맞는 운동메이트를 만날 수 있어요.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Zap className="w-8 h-8 text-emerald-600" />
                </div>
                <h3 className="text-xl font-bold mb-3">즉석 모임</h3>
                <p className="text-gray-600">지금 당장 운동하고 싶을 때, 실시간으로 모임을 만들고 참여하세요.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4">
                ...
                <p className="text-gray-600">함께 목표를 세우고 응원하며 성취감을 두 배로 느껴보세요.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="bg-gradient-to-br from-emerald-50 to-blue-50">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 italic">"혼자 러닝하다가 포기하는 일이 많았는데, 밋핀으로 만난 러닝메이트들과 함께하니까 정말 꾸준히 할 수 있게 되었어요! 이제 10km도 뛸 수 있답니다 🏃‍♀️"</p>
              ...
              <Card className="bg-gradient-to-br from-blue-50 to-emerald-50">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 italic">"PT비가 부담스러웠는데 밋핀에서 경험 많은 분과 함께 운동하면서 올바른 자세를 배울 수 있었어요. 이제 스쿼트 100개도 문제없어요! 💪"</p>
                  <div className="flex text-yellow-400 mt-3">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-current" />
                    ))}
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-emerald-600 to-blue-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              ...
              내 운동모임이 상단에 노출되어 더 많은 메이트들과 만날 수 있어요
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="text-lg px-8 bg-transparent border-white text-white hover:bg-white hover:text-emerald-600" onClick={() => router.push('/map?category=exercise')}>

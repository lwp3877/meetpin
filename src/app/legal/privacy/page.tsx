    ...
    <div className="bg-background min-h-screen">
      ...
      <header className="border-b bg-white px-4 py-3">
        <div className="container mx-auto">
          <h1 className="text-primary text-xl font-bold">🔒 개인정보처리방침</h1>
        </div>
      </header>
        ...
        <div className="space-y-6 rounded-lg bg-white p-6 shadow-sm">
          ...
          <div className="space-y-8">
            <section>
              ...
              <div className="text-text-muted space-y-3 leading-relaxed">
                <p>
                  {brandMessages.appName}(이하 &ldquo;회사&rdquo;)는 다음의 목적을 위하여 개인정보를
                  처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며,
                  이용 목적이 변경되는 경우에는 개인정보보호법 제18조에 따라 별도의 동의를 받는 등
                  필요한 조치를 이행할 예정입니다.
                </p>

                <div className="rounded-lg bg-gray-50 p-4">
                  <h4 className="mb-2 font-semibold text-gray-900">가. 회원 가입 및 관리</h4>
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  <h4 className="mb-2 font-semibold text-gray-900">나. 서비스 제공</h4>
                  <ul className="space-y-1 pl-4">
                ...
                <div className="rounded-lg bg-gray-50 p-4">
                  <h4 className="mb-2 font-semibold text-gray-900">다. 고객 지원</h4>
                  <ul className="space-y-1 pl-4">
            ...
            <section>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                  <h4 className="mb-3 font-semibold text-blue-900">가. 필수 항목</h4>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      <h5 className="mb-2 font-medium text-blue-800">회원가입 시</h5>
                    ...
                    <div>
                      <h5 className="mb-2 font-medium text-blue-800">서비스 이용 시</h5>
                      <ul className="space-y-1 text-sm">
                        <li>• 위치정보 (GPS 좌표)</li>
                        <li>• 서비스 이용 기록</li>
                        <li>• 접속 로그, 쿠키</li>
                ...
                <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                  <h4 className="mb-3 font-semibold text-green-900">나. 선택 항목</h4>
                  <div className="grid gap-4 md:grid-cols-2">
                    <div>
                      <h5 className="mb-2 font-medium text-green-800">프로필 설정</h5>
                      <ul className="space-y-1 text-sm">
                        <li>• 프로필 사진</li>
                        <li>• 자기소개</li>
                        <li>• 관심 카테고리</li>
                    ...
                    <div>
                      <h5 className="mb-2 font-medium text-green-800">결제 정보</h5>
                      <ul className="space-y-1 text-sm">
            ...
            <section>
              <h3 className="text-text mb-4 text-lg font-semibold">6. 개인정보의 파기</h3>
              <div className="text-text-muted space-y-3 leading-relaxed">
                <p>
                ...
                <div className="rounded-lg border border-red-200 bg-red-50 p-4">
                  <h4 className="mb-2 font-semibold text-red-900">파기절차</h4>
                ...
                <div className="rounded-lg border border-red-200 bg-red-50 p-4">
                  <h4 className="mb-2 font-semibold text-red-900">파기방법</h4>
                  <ul className="space-y-1 text-sm text-red-800">
                    <li>
                      • 전자적 파일 형태: 기록을 재생할 수 없도록 로우레벨 포맷 등의 방법을 이용하여
                      파기
                    </li>
              ...
              <div className="text-text-muted space-y-3 leading-relaxed">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-lg bg-blue-50 p-4">
                    <h4 className="mb-2 font-semibold text-blue-900">정보주체의 권리</h4>
                    <ul className="space-y-1 text-sm">
                  ...
                  <div className="rounded-lg bg-green-50 p-4">
                    <h4 className="mb-2 font-semibold text-green-900">권리 행사 방법</h4>
                    <ul className="space-y-1 text-sm">
                      <li>• 서비스 내 설정 메뉴</li>
              ...
              <div className="text-text-muted space-y-4 leading-relaxed">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                    <h4 className="mb-2 font-semibold text-purple-900">관리적 조치</h4>
                  ...
                  <div className="rounded-lg border border-orange-200 bg-orange-50 p-4">
                    <h4 className="mb-2 font-semibold text-orange-900">기술적 조치</h4>
                  ...
                  <div className="rounded-lg border border-teal-200 bg-teal-50 p-4">
                    <h4 className="mb-2 font-semibold text-teal-900">물리적 조치</h4>
            ...
            <section>
              <h3 className="text-text mb-4 text-lg font-semibold">9. 개인정보 보호책임자</h3>
              <div className="text-text-muted space-y-3 leading-relaxed">
                <p>
                ...
                <div className="rounded-lg border bg-gray-50 p-6">
                  <div className="grid gap-6 md:grid-cols-2">
                    <div>
                      <h4 className="mb-3 font-semibold text-gray-900">개인정보 보호책임자</h4>
                      <ul className="space-y-2 text-sm">
                        <li>
                          <strong>성명:</strong> 이원표
                        </li>
                        <li>
                          <strong>직책:</strong> 개발팀장
                        </li>
                        <li>
                          <strong>연락처:</strong> privacy@meetpin.kr
                        </li>
                        <li>
                    ...
                    <div>
                      <h4 className="mb-3 font-semibold text-gray-900">개인정보 보호담당부서</h4>
                      <ul className="space-y-2 text-sm">
                        <li>
                          <strong>부서명:</strong> 개발팀
                        </li>
                        <li>
                          <strong>담당자:</strong> 개인정보보호팀
                        </li>
                        <li>
                          <strong>연락처:</strong> privacy@meetpin.kr
                        </li>
            ...
            <section>
              <h3 className="text-text mb-4 text-lg font-semibold">10. 권익침해 구제방법</h3>
              <div className="text-text-muted space-y-3 leading-relaxed">
                <p>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                    <h4 className="mb-2 font-semibold text-blue-900">개인정보보호위원회</h4>
                  ...
                  <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                    <h4 className="mb-2 font-semibold text-green-900">개인정보 침해신고센터</h4>
                  ...
                  <div className="rounded-lg border border-red-200 bg-red-50 p-4">
                    <h4 className="mb-2 font-semibold text-red-900">경찰청 사이버테러대응센터</h4>
                    <ul className="space-y-1 text-sm text-red-800">
            ...
            <section>
              <h3 className="text-text mb-4 text-lg font-semibold">11. 개인정보 처리방침 변경</h3>
              <div className="text-text-muted space-y-3 leading-relaxed">
                <p>
          ...
          <div className="mt-8 rounded-lg border border-blue-200 bg-blue-50 p-4">
            <p className="text-sm text-blue-800">
              🚧 <strong>법무 검토 중:</strong> 완전한 개인정보처리방침은 개인정보보호 전문가의
              검토를 거쳐 업데이트될 예정입니다.
            </p>
          </div>
        </div>

        ...
        <section className={`py-20 px-4 transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              근처에서 함께 술 마실 친구를 찾아보세요!<br />
              실시간 술모임에 참여하고 새로운 인연을 만나보세요
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="text-lg px-8" onClick={() => router.push('/map?category=drink')}>
                <MapPin className="mr-2 h-5 w-5" />
                근처 술모임 찾기
              </Button>
              <Button size="lg" variant="outline" className="text-lg px-8" onClick={() => router.push('/room/new?category=drink')}>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {DRINK_SPOTS.map((spot, index) => (
                <Card key={spot.name} className={`hover:shadow-lg transition-all duration-300 cursor-pointer transform hover:-translate-y-1 ${isVisible ? 'animate-in slide-in-from-bottom-4' : ''}`} 
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {DRINK_TYPES.map((drink, index) => (
                <Card key={drink.type} className={`hover:shadow-md transition-all duration-300 cursor-pointer ${isVisible ? 'animate-in slide-in-from-left-4' : ''}`}
                      style={{ animationDelay: `${index * 0.1}s` }}
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="text-center">
                ...
                <h3 className="text-xl font-bold mb-3">실시간 위치 기반</h3>
                <p className="text-gray-600">내 주변 500m 이내 실시간 술모임을 지도에서 한눈에 확인하고 바로 참여하세요.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Users className="w-8 h-8 text-orange-600" />
                </div>
                <h3 className="text-xl font-bold mb-3">안전한 만남</h3>
                <p className="text-gray-600">본인인증을 거친 사용자들과만 만나고, 1:1 채팅으로 사전에 대화해보세요.</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-4">
                  <Star className="w-8 h-8 text-orange-600" />
                </div>
                <h3 className="text-xl font-bold mb-3">평점 시스템</h3>
                <p className="text-gray-600">모임 후 상호 평점을 남기고 좋은 사람들과 다시 만날 수 있어요.</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <Card className="bg-white">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 italic">"혼자 와인 마시기 아쉬웠는데, 근처에서 취향 비슷한 사람들을 만날 수 있어서 너무 좋아요! 이제 주말마다 새로운 와인바 탐방하고 있어요 ✨"</p>
              ...
              <Card className="bg-white">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-700 italic">"직장 동료들이랑만 마시다가 밋핀으로 새로운 사람들 만나니까 정말 재밌어요! 이제 정기 술모임까지 생겼답니다 🍺"</p>
                  <div className="flex text-yellow-400 mt-3">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-current" />
                    ))}
        ...
        <section className="py-20 px-4 bg-gradient-to-r from-orange-600 to-red-600 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 opacity-90">
              ...
              내 술모임이 상단에 노출되어 더 많은 사람들과 만날 수 있어요
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="text-lg px-8 bg-transparent border-white text-white hover:bg-white hover:text-orange-600" onClick={() => router.push('/map?category=drink')}>

...
// 개발자 모드 (Mock 데이터 사용) - 프로덕션 환경에서도 Mock 모드 활성화
// 프로덕션 데모: 환경변수 설정 없이도 앱이 동작하도록 보장
export const isDevelopmentMode = process.env.NEXT_PUBLIC_USE_MOCK_DATA !== 'false' || process.env.NODE_ENV === 'production'

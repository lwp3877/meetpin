...
const seoulHotspots = [
  ...
  { name: '한남동', lat: 37.5340, lng: 127.0026, district: '용산구' },
  ...
  { name: '문래동', lat: 37.5184, lng: 126.8950, district: '영등포구' },
]
...
const botProfiles = [
  ...
  { nickname: '칵테일마스터', ageRange: '30s_early', category: 'drink', personality: 'sophisticated' },
  ...
  { nickname: '헬스트레이너김', ageRange: '30s_early', category: 'exercise', personality: 'motivational' },
  { nickname: '요가인스트럭터', ageRange: '20s_late', category: 'exercise', personality: 'peaceful' },
  { nickname: '클라이밍매니아', ageRange: '30s_early', category: 'exercise', personality: 'challenging' },
  { nickname: '테니스코치', ageRange: '30s_late', category: 'exercise', personality: 'competitive' },
  ...
  for (let i = 0; i < count; i++) {
    try {
      ...
      if (!preferredCategories.includes(room.category)) {
        const newCategory = preferredCategories[Math.floor(Math.random() * preferredCategories.length)]

        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
            <div className="flex items-center space-x-3 rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
              <div
                className={`h-3 w-3 rounded-full ${status.isRunning ? 'animate-pulse bg-green-500' : 'bg-gray-400'}`}
              ></div>
              <div>
                <div className="text-sm text-gray-600 dark:text-gray-400">상태</div>
                <div className="font-semibold">{status.isRunning ? '실행 중' : '중지됨'}</div>
              </div>
            </div>
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
              <h4 className="mb-3 font-semibold">요일별 생성량 조정</h4>
            ...
            {/* 주요 지역 분포 */}
            <div className="rounded-lg bg-gray-50 p-4 dark:bg-gray-800">
              <h4 className="mb-3 font-semibold">주요 생성 지역</h4>
        ...
        <CardContent>
          <div className="space-y-3 text-sm text-gray-600 dark:text-gray-400">
            <div className="flex items-start space-x-3">
              ...
              <div>
                <strong>자동 시간 관리:</strong> 하루 24시간 동안 미리 정의된 시간표에 따라 자동으로
                봇 방을 생성합니다.
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500" />
              <div>
                <strong>요일별 조정:</strong> 주말과 평일에 따라 생성량을 자동 조정하여 현실적인
                활동 패턴을 시뮬레이션합니다.
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500" />
              <div>
                <strong>지역별 분산:</strong> 각 시간대마다 적절한 지역에 가중치를 두어 방을
                생성하여 자연스러운 분포를 만듭니다.
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <CheckCircle className="mt-0.5 h-4 w-4 flex-shrink-0 text-green-500" />
              <div>
                <strong>카테고리 최적화:</strong> 시간대에 맞는 적절한 모임 카테고리를 선택하여
                현실감을 높입니다.
              </div>
            </div>
          </div>

...
export default function CookieSettingsModal({
  ...
  useEffect(() => {
    if (currentPreferences) {
      ...
      setHasChanges(
        analyticsEnabled !== originalAnalytics || 
        marketingEnabled !== originalMarketing
      )
    }
                  ...
                  <CardHeader className="pb-3">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Icon className={`w-5 h-5 mr-3 ${categoryColors[key as keyof typeof categoryColors]}`} />
                        <div>
                    ...
                    <div className="border-t pt-3">
                      ...
                      <div className="space-y-1 text-sm">
                        ...
                        <div className="flex justify-between">
                          <span>분석 쿠키:</span>
                          <Badge 
                            variant={currentPreferences.analytics === 'granted' ? 'default' : 'outline'}
                            className={currentPreferences.analytics === 'granted' ? 'bg-blue-50 text-blue-700' : ''}
                          >
                        ...
                        <div className="flex justify-between">
                          <span>마케팅 쿠키:</span>
                          <Badge 
                            variant={currentPreferences.marketing === 'granted' ? 'default' : 'outline'}
                            className={currentPreferences.marketing === 'granted' ? 'bg-purple-50 text-purple-700' : ''}
                          >

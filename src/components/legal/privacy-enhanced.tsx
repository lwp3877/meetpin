  ...
  return (
    <Card className="border-orange-200 bg-orange-50/50">
      <CardHeader className="pb-4">
        ...
        <div className="flex items-start space-x-2 text-sm text-orange-700 bg-orange-100 p-3 rounded-lg">
          ...
          <div>
            ...
            <p className="text-xs mt-1">각 항목별로 상세한 내용을 확인하고 동의해주세요.</p>
          </div>
        </div>
      </CardHeader>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="border rounded-lg p-4 bg-white">
          <div className="flex items-start space-x-3">
            ...
            <div className="flex-1">
              <label htmlFor="essential" className="flex items-center space-x-2 cursor-pointer">
                <span className="font-medium text-gray-900">서비스 이용을 위한 개인정보 수집·이용</span>
                <span className="text-red-600 text-xs font-bold">(필수)</span>
              </label>
              ...
              {showDetails.essential && (
                <div className="mt-3 p-3 bg-gray-50 rounded text-sm space-y-2">
                  ...
                  <div>
                    <strong>처리방침:</strong> 개인정보는 암호화되어 저장되며, 제3자에게 제공되지 않습니다.
                  </div>
                  <div>
                    <strong>거부권:</strong> 필수항목 동의를 거부할 권리가 있으나, 서비스 이용이 제한됩니다.
                  </div>
                </div>
              )}
            </div>
        ...
        {/* 민감정보 동의 - 연령대 */}
        <div className="border rounded-lg p-4 bg-white border-yellow-200">
          <div className="flex items-start space-x-3">
            <Checkbox
              id="ageRange"
            ...
            />
            <div className="flex-1">
              <label htmlFor="ageRange" className="flex items-center space-x-2 cursor-pointer">
                <span className="font-medium text-gray-900">연령대 정보 수집·이용</span>
                <span className="text-orange-600 text-xs font-bold">(민감정보/필수)</span>
              ...
              {showDetails.ageRange && (
                <div className="mt-3 p-3 bg-yellow-50 rounded text-sm space-y-2">
                  <div>
                  ...
                  <div>
                    <strong>보안조치:</strong> 연령대 정보는 암호화 저장되며, 최소한의 담당자만 접근 가능합니다.
                  </div>
        ...
        <div className="border rounded-lg p-4 bg-white">
          <div className="flex items-start space-x-3">
            ...
            />
            <div className="flex-1">
              <label htmlFor="analytics" className="flex items-center space-x-2 cursor-pointer">
        ...
        <div className="mt-6 p-4 bg-gray-50 rounded-lg">
          <h4 className="font-medium text-gray-900 mb-2">동의 현황</h4>
          <div className="space-y-1 text-sm">
            <div className="flex justify-between">
              <span>필수 동의</span>
              <span className={consents.essential && consents.ageRange ? 'text-green-600' : 'text-red-600'}>
        ...
        <div className="text-xs text-gray-500 leading-relaxed">
          ...
          <p>• 자세한 내용은 <a href="/legal/privacy" className="text-blue-600 underline">개인정보처리방침</a>을 확인해주세요.</p>
        </div>
      </CardContent>
    </Card>
  )
